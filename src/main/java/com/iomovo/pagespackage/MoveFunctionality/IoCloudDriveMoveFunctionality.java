...
public class IoCloudDriveMoveFunctionality extends BaseClass {

	WebDriver driver;
	WebDriverWait wait;

	public IoCloudDriveMoveFunctionality(WebDriver driver, WebDriverWait wait) {
		this.driver = driver;
		this.wait = wait;	}
	...
	String aWSDriveFolderSelectionRoot = "//*[text()='automationfolder']";
...
//	String sharePointFolderSelectionL1 = "//span[text()='Automationtestingfolder-DND']";
	...
	String moveFilesConfirmation = "//div/p/*[contains (text(),'Copied successfully')]";
	...
	/**
	 *This Method Navigates to the ioCloud Drive
	 *
	 * @author Mudassir
	 */
	public void navigateToIoCloudDrive(String caseName) {
		try {
			logPassStepInExtentReport(caseName);
			clickWebElement(leftPanelIoHubButton);
			clickWebElement(leftPanelIoCloudButton);
			logPassStepInExtentReportWithScreenshot("IoCloud Drive button clicked successfully");
	...
	/**
	 *This Method Moves Data From ioCloud Source Folder
	 *
	 * @author Mudassir
	 */
	public void moveFilesFromSourceFolder() {
		try {
			...
			logPassStepInExtentReportWithScreenshot(" Selecting The Files from IoCloud Drive ");	
			explicitWaitInSeconds(3);
	...
	/**
	 *This Method Pastes the Data Moved From ioCloud Source Folder
	 *
	 * @author Mudassir
	 */
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToIoCloudDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 001 : Verify Move Function From IoCloud To IoCloud Drive");
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("IoCloudToIoCloud"));
			explicitWaitInSeconds(3);
			...
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To IoCloud Drive");
			} else {
			...
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromIoCloudToIoCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}

	public void verifyMoveFilesFunctionalityFromIoCloudToAwsDrive() {
		try {
			navigateToIoCloudDrive("TC 002 : Verify Move Function From IoCloud To AWS Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToAWS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To AWS Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToAWSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToBoxDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 003 : Verify Move Function From IoCloud To Box Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To Box Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToDropbox() throws Exception {
		try {
			navigateToIoCloudDrive("TC 004 : Verify Move Function From IoCloud To Dropbox Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToDropbox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To Dropbox Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToDropboxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToFTPDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 005 : Verify Move Function From IoCloud To FTP Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToFtp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To FTP Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToGoogleCloudDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 006 : Verify Move Function From IoCloud To GoogleCloud Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToGoogleCloud"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To GoogleCloud Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToGoogleCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToGoogleDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 007 : Verify Move Function From IoCloud To Google Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToGoogleDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To Google Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToGoogleDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToAzureDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 008 : Verify Move Function From IoCloud To Azure Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToAzure"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To Azure Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToAzureDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToOneDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 009 : Verify Move Function From IoCloud To OneDrive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToOneDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To OneDrive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToOneDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	
	public void verifyMoveFilesFunctionalityFromIoCloudToOOSDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 010 : Verify Move Function From IoCloud To OOS Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToOOS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To OOS Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToOOSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToSFTPDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 011 : Verify Move Function From IoCloud To SFTP Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToSftp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To SFTP Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToSFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromIoCloudToSharepointDrive() throws Exception {
		try {
			navigateToIoCloudDrive("TC 012 : Verify Move Function From IoCloud To Sharepoint Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("IoCloudToSharepoint"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From IoCloud To Sharepoint Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromIoCloudToSharepointDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
}