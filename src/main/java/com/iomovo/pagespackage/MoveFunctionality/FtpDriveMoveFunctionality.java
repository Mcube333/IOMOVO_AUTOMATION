...
//	String sharePointFolderSelectionL1 = "//span[text()='Automationtestingfolder-DND']";
	 ...
	 * @author Mudassir
	 */
	public void navigateToFtpDrive(String caseName) {
		try {
			logPassStepInExtentReport(caseName);
			clickWebElement(leftPanelIoHubButton);
			clickWebElement(LeftPanelFTPDriveButton);
			logPassStepInExtentReportWithScreenshot("FTP Drive button clicked successfully");
	...
	public void moveFilesFromSourceFolder() {
		try {
			...
			logPassStepInExtentReportWithScreenshot(" Selecting The Files from FTP Drive ");	
			explicitWaitInSeconds(3);
	...
	public void verifyMoveFilesFunctionalityFromFTPToIoCloudDrive() throws Exception {
		try {
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("FtpToIoCloud"));
			explicitWaitInSeconds(3);
			...
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To IoCloud Drive");
			} else {
			...
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToIoCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToAWSDrive() throws Exception {
		try {
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpath("FtptoAWS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To Aws Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToAWSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToBOXDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtptoBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToBOXDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToDropBoxDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtptoDropBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To DropBox Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToDropBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToFTPDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtptoFtp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To FTP Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToGoogleCloudDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtptoGoogleCloud"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To GoogleCloud Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToGoogleCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToGoogleDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtptoGoogleDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To Google Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToGoogleDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToAzureDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtptoAzure"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To Azure Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToAzureDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToOneDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtpToOneDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To OneDrive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToOneDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToOOSDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtpToOOS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From FTP To OOS");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToOOSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToSFTPDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("FtpToSftp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To SFTP");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToSFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromFTPToSharePointDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpath("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("FtpToSharePoint"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From Ftp To SharePoint");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromFTPToSharePointDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
}
