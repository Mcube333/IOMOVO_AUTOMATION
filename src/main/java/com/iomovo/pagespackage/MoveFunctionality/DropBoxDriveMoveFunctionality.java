...
public class DropBoxDriveMoveFunctionality extends BaseClass {

	public DropBoxDriveMoveFunctionality(WebDriver driver, WebDriverWait wait) {
...
//	String sharePointFolderSelectionL1 = "//span[text()='Automationtestingfolder-DND']";
	...
	/**
	 *This Method Navigates to the DropBox Drive
	 *
	 * @author Mudassir
	 */
	public void navigateToDropBoxDrive(String caseName) {
		try {
			logPassStepInExtentReport(caseName);
			clickWebElement(leftPanelIoHubButton);
			clickWebElement(LeftPanelDropBoxDriveButton);
			logPassStepInExtentReportWithScreenshot("DropBox Drive button clicked successfully");
	...
	/**
	 *This Method Moves Data From DropBox Source Folder
	 *
	 * @author Mudassir
	 */
	public void moveFilesFromSourceFolder() {
		try {
			...
			logPassStepInExtentReportWithScreenshot(" Selecting The Files from DropBox Drive ");	
			explicitWaitInSeconds(3);
	...
	/**
	 *This Method Pastes the Data Moved From DropBox Source Folder
	 *
	 * @author Mudassir
	 */
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToIoCloudDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 001 : Verify Move Files Functionality From DropBox To ioCloud Drive");
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("DropBoxToIoCloud"));
			explicitWaitInSeconds(3);
			...
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To IoCloud Drive");
			} else {
			...
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToIoCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToAWSDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 002 : Verify Move Files Functionality From DropBox To Aws Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpath("DropBoxtoAWS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To Aws Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToAwsDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToBOXDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 003 : Verify Move Function From DropBox To Box Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxtoBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To Box Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToBOXDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToDropBoxDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 004 : Verify Move Function From DropBox To DropBox Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			clickWebElement(LeftPanelDropBoxDriveButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxtoDropBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To DropBox Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToDropBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToFTPDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 005 : Verify Move Function From DropBox To FTP Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxtoFtp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To FTP Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToGoogleCloudDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 006 : Verify Move Function From DropBox To GoogleCloud Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxtoGoogleCloud"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To GoogleCloud Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToGoogleCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToGoogleDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 007 : Verify Move Function From DropBox To Google Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxtoGoogleDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To Google Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToGoogleDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToAzureDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 008 : Verify Move Function From DropBox To Azure Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxtoAzure"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To Azure Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToAzureDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToOneDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 009 : Verify Move Function From DropBox To OneDrive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxToOneDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To OneDrive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToOneDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	
	public void verifyMoveFilesFunctionalityFromDropBoxToOOSDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 010 : Verify Move Function From DropBox To OOS Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxToOOS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To OOS");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToOOSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToSFTPDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 011 : Verify Move Function From DropBox To SFTP Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxToSftp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To SFTP");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToSFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromDropBoxToSharePointDrive() throws Exception {
		try {
			navigateToDropBoxDrive("TC 012 : Verify Move Function From DropBox To SharePoint Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpath("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("DropBoxToSharePoint"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From DropBox To SharePoint");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromDropBoxToSharePointDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
}