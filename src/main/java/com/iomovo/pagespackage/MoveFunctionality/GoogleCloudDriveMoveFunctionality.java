...
public class GoogleCloudDriveMoveFunctionality extends BaseClass {

	WebDriver driver;
	WebDriverWait wait;

	public GoogleCloudDriveMoveFunctionality(WebDriver driver, WebDriverWait wait) {
		this.driver = driver;
		this.wait = wait;	}
...
//	String sharePointFolderSelectionL1 = "//span[text()='Automationtestingfolder-DND']";
	...
	/**
	 *This Method Navigates to the GoogleCloud Drive
	 *
	 * @author Mudassir
	 */
	...
	/**
	 *This Method Moves Data From GoogleCloud Source Folder
	 *
	 * @author Mudassir
	 */
	...
	/**
	 *This Method Pastes the Data Moved From GoogleCloud Source Folder
	 *
	 * @author Mudassir
	 */
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToIoCloudDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 001 : Verify Move Files Functionality From GoogleCloud To ioCloud Drive");
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("GoogleCloudToIoCloud"));
			explicitWaitInSeconds(3);
			...
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To IoCloud Drive");
			} else {
			...
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToIoCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToAWSDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 002 : Verify Move Files Functionality From GoogleCloud To Aws Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpath("GoogleCloudtoAWS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To Aws Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToAwsDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToBOXDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 003 : Verify Move Function From GoogleCloud To Box Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudtoBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To Box Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToBOXDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToDropBoxDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 004 : Verify Move Function From GoogleCloud To DropBox Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudtoDropBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To DropBox Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToDropBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToFTPDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 005 : Verify Move Function From GoogleCloud To FTP Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudtoFtp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To FTP Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToGoogleCloudDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 006 : Verify Move Function From GoogleCloud To GoogleCloud Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			clickWebElement(LeftPanelGoogleCloudDriveButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudtoGoogleCloud"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To GoogleCloud Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToGoogleCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToGoogleDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 007 : Verify Move Function From GoogleCloud To Google Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudtoGoogleDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To Google Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToGoogleDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToAzureDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 008 : Verify Move Function From GoogleCloud To Azure Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudtoAzure"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To Azure Drive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToAzureDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToOneDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 009 : Verify Move Function From GoogleCloud To OneDrive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudToOneDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To OneDrive");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToOneDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	
	public void verifyMoveFilesFunctionalityFromGoogleCloudToOOSDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 010 : Verify Move Function From GoogleCloud To OOS Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudToOOS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To OOS");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToOOSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToSFTPDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 011 : Verify Move Function From GoogleCloud To SFTP Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("GoogleCloudToSftp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To SFTP");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToSFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyMoveFilesFunctionalityFromGoogleCloudToSharePointDrive() throws Exception {
		try {
			navigateToGoogleCloudDrive("TC 012 : Verify Move Function From GoogleCloud To SharePoint Drive");
			moveFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpath("Move Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioCloud("GoogleCloudToSharePoint"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Moved From GoogleCloud To SharePoint");
			} else {
				logFailStepInExtentReport(" Files Not Moved ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyMoveFilesFunctionalityFromGoogleCloudToSharePointDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
}