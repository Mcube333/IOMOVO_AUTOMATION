...
public class SharePointAudio_VideoConvertFunctionality extends BaseClass {

	WebDriver driver;
	WebDriverWait wait;

	public SharePointAudio_VideoConvertFunctionality(WebDriver driver, WebDriverWait wait) {
		this.driver = driver;
		this.wait = wait;
	}

	
	String sharePointFolderSelectonRoot = "//div/span[text()='ioMoVoQATeam']";
	...
	String automationFolderGrid = "//p[@aria-label='filename']//following::span[text()='automationfolder']";
	String automationfolderList = "//*/a[text()='automationfolder']";
	...
	public void verifyAudioConvertFunctionalityInSharePoint() throws Exception {
		...
		try {
			logPassStepInExtentReport("TC 001 : Verify Audio Convert Functionality (.MP3) Format File In SharePoint");
			...
			logPassStepInExtentReport("SharePoint button clicked successfully");
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(sharePointFolderSelectonRoot);
			explicitWaitInSeconds(3);
			clickWebElement(switchToGridViewButton);
			clickWebElement(automationFolderGrid);
			doubleClickUsingActionClass(automationFolderGrid);
...
//			String[] formats = {"AU ","WAV "}; 
	...
	public void verifyVideoConvertFunctionalityInSharePoint() throws Exception {
		try {
			logPassStepInExtentReport("TC 002 : Verify Video Convert Functionality (.MP4) Format File In SharePoint");
...
//					"MTS ", "MTV ", "MXF ", "OGV ", "R3D ", "RM ", "SWF ", "TS ", "VIDEO ", "VOB ", "VP8 ", "WEBM ", "WMV ", "WTV ", "XESC ", "YUV "};
	...
	public void verifyVideo2AudioConvertFunctionalityInSharePoint() throws Exception {
		...
		try {
			logPassStepInExtentReport("TC 003 : Verify Video To Audio Convert Functionality (.MP4) Format File In SharePoint");
