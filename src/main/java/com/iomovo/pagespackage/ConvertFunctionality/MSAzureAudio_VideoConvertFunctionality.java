...
public class MSAzureAudio_VideoConvertFunctionality extends BaseClass {
	...
	String msazureSearchBar = "//input[@id='free-solo-demo']";
	...
	public void verifyAudioConvertFunctionalityInMSAzure() throws Exception {
		...
		try {
			...
			logPassStepInExtentReport("MSAzure Drive button clicked successfully");
			explicitWaitInSeconds(3);
			setTextAndClickEnterInTextField(msazureSearchBar, strFolderName);
			explicitWaitInSeconds(2);
//			isWebElementDisplayed(automationFolder);
	...
	public void verifyVideoConvertFunctionalityInMSAzure() throws Exception {
		try {
			...
			// Update the Below Code for Single Format / Desired Video Format Conversion and comment the Below String
				        ...
				        String[] formats = {"Effi", "ISMV ", "M2TS ", "M2V ", "M4V ", "MJPEG ", "MKV ", "MOV ", "MPEG ", "MPEG2 ", "MPEG4 ", "MPG ",
...
//					"H264 ", "H265 ", "Effi", "ISMV ", "M2TS ", "M2V ", "M4V ", "MJPEG ", "MKV ", "MOV ", "MPEG ", "MPEG2 ", "MPEG4 ", "MPG ",
//					"MTS ", "MTV ", "MXF ", "OGV ", "R3D ", "RM ", "SWF ", "TS ", "VIDEO ", "VOB ", "VP8 ", "WEBM ", "WMV ", "WTV ", "XESC ", "YUV "};
			...
			for (String format : formats) {
				try {
					...
					clickWebElementWithoutScrolling(transcodeButton);
					logPassStepInExtentReport("Clicking on Transcode Button");

					clickWebElementWithoutScrolling(formatInputField);
					logPassStepInExtentReport("Clicking on Format Dropdown Button");
					explicitWaitInSeconds(2);
					...
					clickWebElementWithoutScrolling(resolutionDropdownButton);
