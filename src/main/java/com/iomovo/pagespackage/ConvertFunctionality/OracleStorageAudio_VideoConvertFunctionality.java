...
public class OracleStorageAudio_VideoConvertFunctionality extends BaseClass {

	public OracleStorageAudio_VideoConvertFunctionality(WebDriver driver, WebDriverWait wait) {
	...
	public void verifyAudioConvertFunctionalityInOracleStorage() throws Exception {
		...
		try {
			logPassStepInExtentReport("TC 001 : Verify Audio Convert Functionality (.MP3) Format File In Oracle Storage");

			clickWebElement(leftPanelIoHubButton);
			logPassStepInExtentReport("ioHub button clicked successfully");
			explicitWaitInSeconds(2);
			clickWebElement(LeftPanelOraleDriveButton);
			logPassStepInExtentReport("Oracle Storage button clicked successfully");
...
//			String[] formats = {"TTA ", "VOC ", "W64 ", "WAV ", "WV " }; 
	...
	public void verifyVideoConvertFunctionalityInOracleStorage() throws Exception {
		try {
			logPassStepInExtentReport("TC 002 : Verify Video Convert Functionality (.MP4) Format File In OracleStorage");

			clickWebElement(leftPanelIoHubButton);
			logPassStepInExtentReport("ioHub button clicked successfully");
			explicitWaitInSeconds(2);
			clickWebElement(LeftPanelOraleDriveButton);
			logPassStepInExtentReport("OracleStorage button clicked successfully");
			explicitWaitInSeconds(3);
			clickWebElement(automationFolder);
...
//					"MTS ", "MTV ", "MXF ", "OGV ", "R3D ", "RM ", "SWF ", "TS ", "VIDEO ", "VOB ", "VP8 ", "WEBM ", "WMV ", "WTV ", "XESC ", "YUV "};
	...
	public void verifyVideo2AudioConvertFunctionalityInOracleStorage() throws Exception {
		...
		try {
			logPassStepInExtentReport("TC 003 : Verify Video To Audio Convert Functionality (.MP4) Format File In OracleStorage");
