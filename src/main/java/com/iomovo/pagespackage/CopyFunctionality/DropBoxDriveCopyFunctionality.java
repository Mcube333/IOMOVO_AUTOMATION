...
public class DropBoxDriveCopyFunctionality extends BaseClass {
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToIoCloudDrive() throws Exception {
		try {
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("DropBoxToIoCloud"));
			explicitWaitInSeconds(3);
			...
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To IoCloud Drive");
			} else {
			...
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToIoCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToAWSDrive() throws Exception {
		try {
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToAWS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To AWS Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToAWSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToBOXDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To Box Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToDropBoxDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToDropBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To DropBox Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToDropBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToFTPDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToFtp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To FTP Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToGoogleCloudDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToGoogleCloud"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To GoogleCloud Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToGoogleCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToGoogleDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToGoogleDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To Google Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToGoogleDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToAzureDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToAzure"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To Azure Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToAzureDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToOneDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToOneDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To OneDrive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToOneDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToSFTPDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToSftp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To Sftp Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToSftpDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToOOSDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToOOS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To OSS Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToOOSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromDropBoxToSharePointDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("DropBoxToSharePoint"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From DropBox To SharePoint Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromDropBoxToSharePointDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
