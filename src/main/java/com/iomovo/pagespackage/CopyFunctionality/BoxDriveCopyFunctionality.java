...
public class BoxDriveCopyFunctionality extends BaseClass {

	public BoxDriveCopyFunctionality() {
		if (getDriver() == null) {
            throw new IllegalStateException("❌ WebDriver is null in ProfilePage. Ensure it is initialized in BaseClass.");
        }
    }
	
    public BoxDriveCopyFunctionality(WebDriver driver, WebDriverWait wait) {
...
//	String sharePointFolderSelectionL1 = "//span[text()='Automationtestingfolder-DND']";
	 ...
	 * @author Mudassir
	 */
	public void navigateToBoxDrive(String caseName) {
		try {
			logPassStepInExtentReport(caseName);
			clickWebElement(leftPanelIoHubButton);
			clickWebElement(LeftPanelBoxDriveButton);
			logPassStepInExtentReportWithScreenshot("Box Drive button clicked successfully");
	...
	public void copyFilesFromSourceFolder() {
		try {
			...
			logPassStepInExtentReportWithScreenshot(" Selecting The Files from Box Drive ");	
			explicitWaitInSeconds(3);
	...
	public void verifyCopyFilesFunctionalityFromBOXToIoCloudDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 001 : Verify Copy Function From Box To IoCloud Drive");
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("BoxToIoCloud"));
			explicitWaitInSeconds(3);
			...
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To IoCloud Drive");
			} else {
			...
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToIoCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToAWSDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 002 : Verify Copy Function From Box To AWS Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToAWS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To AWS Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToAWSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToBOXDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 003 : Verify Copy Function From Box To Box Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			clickWebElement(LeftPanelBoxDriveButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To Box Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToDropBoxDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 004 : Verify Copy Function From Box To DropBox Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToDropBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To DropBox Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToDropBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToFTPDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 005 : Verify Copy Function From Box To FTP Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToFtp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To FTP Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToFTPDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToGoogleCloudDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 006 : Verify Copy Function From Box To GoogleCloud Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToGoogleCloud"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To GoogleCloud Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToGoogleCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToGoogleDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 007 : Verify Copy Function From Box To Google Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToGoogleDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To Google Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToGoogleDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToAzureDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 008 : Verify Copy Function From Box To Azure Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToAzure"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To Azure Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToAzureDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToOneDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 009 : Verify Copy Function From Box To OneDrive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToOneDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To OneDrive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToOneDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToSFTPDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 010 : Verify Copy Function From Box To Sftp Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToSftp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To Sftp Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToSftpDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToOOSDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 011 : Verify Copy Function From Box To OOS Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToOOS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To OSS Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToOOSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromBOXToSharePointDrive() throws Exception {
		try {
			getDriverInstance();
			navigateToBoxDrive("TC 012 : Verify Copy Function From Box To SharePoint Drive");
			copyFilesFromSourceFolder();
			clickWebElement(leftPanelIoHubButton);
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("BoxToSharePoint"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Box To SharePoint Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromBOXToSharePointDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
