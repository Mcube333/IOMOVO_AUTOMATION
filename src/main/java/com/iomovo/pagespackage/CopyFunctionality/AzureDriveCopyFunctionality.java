...
//	String sharePointFolderSelectionL1 = "//span[text()='Automationtestingfolder-DND']";
	...
	public void verifyCopyFilesFunctionalityFromAzureToIoCloudDrive() throws Exception {
		try {
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioCloud("AzureToIoCloud"));
			explicitWaitInSeconds(3);
			...
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To IoCloud Drive");
			} else {
			...
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToIoCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToAWSDrive() throws Exception {
		try {
			...
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToAWS"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To AWS Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToAWSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToBoxDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To Box Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToDropBoxDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToDropBox"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To DropBox Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToDropBoxDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToFTPDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToFtp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To Ftp Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToFtpDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToGoogleCloudDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToGoogleCloud"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To GoogleCloud Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToGoogleCloudDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToGoogleDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToGoogleDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To Google Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToGoogleDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToAzureDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToAzure"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To Azure Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToAzureDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToOneDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToOneDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To One Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToOneDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToOOSDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToOOSDrive"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To OOS Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToOOSDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToSFTPDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToSftp"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To Sftp Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToSftpDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	public void verifyCopyFilesFunctionalityFromAzureToSharePointDrive() throws Exception {
		try {
			...
			doubleClickUsingActionClassWithoutScrolling(commonFolderXpathioHub("Copy Folder"));
			explicitWaitInSeconds(3);
			doubleClickUsingActionClass(commonFolderXpathioHub("AzureToSharePoint"));
			explicitWaitInSeconds(3);
			pasteFilesToTargetFolder();

			String copiedSuccessOrFailureMessage = pasteFilesToTargetFolder();
			if (!copiedSuccessOrFailureMessage.contains("Failed")) {
				logPassStepInExtentReportWithScreenshot(" File Successfully Copied From Azure To SharePoint Drive");
			} else {
				logFailStepInExtentReport(" Files Not Copied ");
				assertTrue(true);
			}
			...
			e.printStackTrace();
			logFailStepInExtentReport(
					"Failed In verifyCopyFilesFunctionalityFromAzureToSharePointDrive Method. Failure Exception: " + e);
			assertTrue(false);
		}
	}
	...
	//			doubleClickUsingActionClass(iocloudDriveFolderSelectionCopy);
