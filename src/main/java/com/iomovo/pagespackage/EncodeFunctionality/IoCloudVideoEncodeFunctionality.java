...
public class IoCloudVideoEncodeFunctionality extends BaseClass{

	public IoCloudVideoEncodeFunctionality() {
		if (getDriver() == null) {
            throw new IllegalStateException("❌ WebDriver is null in ProfilePage. Ensure it is initialized in BaseClass.");
        }
    }
	
    public IoCloudVideoEncodeFunctionality(WebDriver driver, WebDriverWait wait) {
	...
	String leftPanelIoCloudDriveButton = "//li[@title='Digital Asset Management']";
	...
	public void verifyVideoEncoding(String resolutionXPath, String testCaseName) throws Exception {
	    try {
	        ...
	        clickWebElement(leftPanelIoCloudDriveButton);
	...
	public void VerifyVideoEncodeFunctionalityto1080pinIoCloudDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution1080P, "TC 001: Verify Video Encode Functionality to 1080p in IoCloud Drive");
	}

	public void VerifyVideoEncodeFunctionalityto720pinIoCloudDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution720P, "TC 002: Verify Video Encode Functionality to 720p in IoCloud Drive");
	}

	public void VerifyVideoEncodeFunctionalityto480pinIoCloudDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution480P, "TC 003: Verify Video Encode Functionality to 480p in IoCloud Drive");
	}
	
	public void VerifyVideoEncodeFunctionalityto360pinIoCloudDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution360P, "TC 004: Verify Video Encode Functionality to 360p in IoCloud Drive");
	}
	
	public void VerifyVideoEncodeFunctionalityto240pinIoCloudDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution240P, "TC 005: Verify Video Encode Functionality to 240p in IoCloud Drive");
	}
