...
public class GoogleDriveVideoEncodeFunctionality extends BaseClass{

	public GoogleDriveVideoEncodeFunctionality() {
		if (getDriver() == null) {
            throw new IllegalStateException("❌ WebDriver is null in ProfilePage. Ensure it is initialized in BaseClass.");
        }
    }
	
    public GoogleDriveVideoEncodeFunctionality(WebDriver driver, WebDriverWait wait) {
	...
	public void VerifyVideoEncodeFunctionalityto1080pinGoogleDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution1080P, "TC 001: Verify Video Encode Functionality to 1080p in GoogleDrive");
	}

	public void VerifyVideoEncodeFunctionalityto720pinGoogleDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution720P, "TC 002: Verify Video Encode Functionality to 720p in GoogleDrive");
	}

	public void VerifyVideoEncodeFunctionalityto480pinGoogleDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution480P, "TC 003: Verify Video Encode Functionality to 480p in GoogleDrive");
	}
	
	public void VerifyVideoEncodeFunctionalityto360pinGoogleDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution360P, "TC 004: Verify Video Encode Functionality to 360p in GoogleDrive");
	}
	
	public void VerifyVideoEncodeFunctionalityto240pinGoogleDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution240P, "TC 005: Verify Video Encode Functionality to 240p in GoogleDrive");
	}
