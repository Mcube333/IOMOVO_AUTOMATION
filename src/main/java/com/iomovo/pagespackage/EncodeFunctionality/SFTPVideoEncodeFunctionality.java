...
public class SFTPVideoEncodeFunctionality extends BaseClass{

	public SFTPVideoEncodeFunctionality() {
		if (getDriver() == null) {
            throw new IllegalStateException("❌ WebDriver is null in ProfilePage. Ensure it is initialized in BaseClass.");
        }
    }
	
    public SFTPVideoEncodeFunctionality(WebDriver driver, WebDriverWait wait) {
	...
	public void VerifyVideoEncodeFunctionalityto1080pinSFTPDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution1080P, "TC 001: Verify Video Encode Functionality to 1080p in SFTP Drive");
	}

	public void VerifyVideoEncodeFunctionalityto720pinSFTPDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution720P, "TC 002: Verify Video Encode Functionality to 720p in SFTP Drive");
	}

	public void VerifyVideoEncodeFunctionalityto480pinSFTPDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution480P, "TC 003: Verify Video Encode Functionality to 480p in SFTP Drive");
	}
	
	public void VerifyVideoEncodeFunctionalityto360pinSFTPDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution360P, "TC 004: Verify Video Encode Functionality to 360p in SFTP Drive");
	}
	
	public void VerifyVideoEncodeFunctionalityto240pinSFTPDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution240P, "TC 005: Verify Video Encode Functionality to 240p in SFTP Drive");
	}
