...
public class BoxVideoEncodeFunctionality extends BaseClass{

	public BoxVideoEncodeFunctionality() {
		if (getDriver() == null) {
            throw new IllegalStateException("❌ WebDriver is null in ProfilePage. Ensure it is initialized in BaseClass.");
        }
    }
	
    public BoxVideoEncodeFunctionality(WebDriver driver, WebDriverWait wait) {
	...
	public void VerifyVideoEncodeFunctionalityto1080pinBoxDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution1080P, "TC 001: Verify Video Encode Functionality to 1080p in Box Drive");
	}

	public void VerifyVideoEncodeFunctionalityto720pinBoxDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution720P, "TC 002: Verify Video Encode Functionality to 720p in Box Drive");
	}

	public void VerifyVideoEncodeFunctionalityto480pinBoxDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution480P, "TC 003: Verify Video Encode Functionality to 480p in Box Drive");
	}
	
	public void VerifyVideoEncodeFunctionalityto360pinBoxDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution360P, "TC 004: Verify Video Encode Functionality to 360p in Box Drive");
	}
	
	public void VerifyVideoEncodeFunctionalityto240pinBoxDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution240P, "TC 005: Verify Video Encode Functionality to 240p in Box Drive");
	}
