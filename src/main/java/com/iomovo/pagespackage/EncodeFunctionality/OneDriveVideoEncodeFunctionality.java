...
public class OneDriveVideoEncodeFunctionality extends BaseClass{

	public OneDriveVideoEncodeFunctionality() {
		if (getDriver() == null) {
            throw new IllegalStateException("❌ WebDriver is null in ProfilePage. Ensure it is initialized in BaseClass.");
        }
    }
	
    public OneDriveVideoEncodeFunctionality(WebDriver driver, WebDriverWait wait) {
	...
	public void VerifyVideoEncodeFunctionalityto1080pinOneDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution1080P, "TC 001: Verify Video Encode Functionality to 1080p in OneDrive");
	}

	public void VerifyVideoEncodeFunctionalityto720pinOneDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution720P, "TC 002: Verify Video Encode Functionality to 720p in OneDrive");
	}

	public void VerifyVideoEncodeFunctionalityto480pinOneDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution480P, "TC 003: Verify Video Encode Functionality to 480p in OneDrive");
	}
	
	public void VerifyVideoEncodeFunctionalityto360pinOneDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution360P, "TC 004: Verify Video Encode Functionality to 360p in OneDrive");
	}
	
	public void VerifyVideoEncodeFunctionalityto240pinOneDrive() throws Exception {
		getDriverInstance();
	    verifyVideoEncoding(resolution240P, "TC 005: Verify Video Encode Functionality to 240p in OneDrive");
	}
