...
public class SFTPAudio_VideoConvertFunctionalityTest extends BaseClass 
{
	...
	public void SFTPAudio_VideoConvertFunctionality() {
		...
		try {
			...
			SFTPAudio_VideoConvertFunctionality SFTPAudio = new SFTPAudio_VideoConvertFunctionality(driver, wait);
			SFTPAudio.verifyAudioConvertFunctionalityInSFTP();
			
//			SFTPAudio_VideoConvertFunctionality SFTPVideo = new SFTPAudio_VideoConvertFunctionality(driver, wait);
//			SFTPVideo.verifyVideoConvertFunctionalityInSFTP();
			
//			SFTPAudio_VideoConvertFunctionality SFTPVideo2Audio = new SFTPAudio_VideoConvertFunctionality(driver, wait);
//			SFTPVideo2Audio.verifyVideo2AudioConvertFunctionalityInSFTP();
