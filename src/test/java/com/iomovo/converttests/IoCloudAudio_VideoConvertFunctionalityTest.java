...
public class IoCloudAudio_VideoConvertFunctionalityTest extends BaseClass 
{
	...
	public void verifyAudio_VideoConvertFunctionalityInIoCloud() {
		...
		try {
			...
			IoCloudAudio_VideoConvertFunctionality IoCloudDriveAudio = new IoCloudAudio_VideoConvertFunctionality(driver, wait);
			IoCloudDriveAudio.verifyAudioConvertFunctionalityInIoCloud();
			
//			IoCloudAudio_VideoConvertFunctionality IoCloudDriveVideo = new IoCloudAudio_VideoConvertFunctionality(driver, wait);
//			IoCloudDriveVideo.verifyVideoConvertFunctionalityInIoCloud();
			
//			IoCloudAudio_VideoConvertFunctionality IoCloudDriveVideo2Audio = new IoCloudAudio_VideoConvertFunctionality(driver, wait);
//			IoCloudDriveVideo2Audio.verifyVideo2AudioConvertFunctionalityInIoCloud();
