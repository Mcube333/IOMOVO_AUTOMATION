...
public class SharePointAudio_VideoConvertFunctionalityTest extends BaseClass 
{
	...
	@Test
	public void SFTPAudio_VideoConvertFunctionality() {
		...
		try {
			...
			SharePointAudio_VideoConvertFunctionality SharePointAudio = new SharePointAudio_VideoConvertFunctionality(driver, wait);
			SharePointAudio.verifyAudioConvertFunctionalityInSharePoint();
			
//			SharePointAudio_VideoConvertFunctionality SharePointVideo = new SharePointAudio_VideoConvertFunctionality(driver, wait);
//			SharePointVideo.verifyVideoConvertFunctionalityInSharePoint();
			
//			SharePointAudio_VideoConvertFunctionality SharePointVideo2Audio = new SharePointAudio_VideoConvertFunctionality(driver, wait);
//			SharePointVideo2Audio.verifyVideo2AudioConvertFunctionalityInSharePoint();
