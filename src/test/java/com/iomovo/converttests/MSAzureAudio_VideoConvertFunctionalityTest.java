...
public class MSAzureAudio_VideoConvertFunctionalityTest extends BaseClass 
{
	/**
...
//			MSAzureAudio_VideoConvertFunctionality MSAzureAudio = new MSAzureAudio_VideoConvertFunctionality(driver, wait);
//			MSAzureAudio.verifyAudioConvertFunctionalityInMSAzure();
			
			MSAzureAudio_VideoConvertFunctionality MSAzureVideo = new MSAzureAudio_VideoConvertFunctionality(driver, wait);
			MSAzureVideo.verifyVideoConvertFunctionalityInMSAzure();
			
//			MSAzureAudio_VideoConvertFunctionality MSAzureVideo2Audio = new MSAzureAudio_VideoConvertFunctionality(driver, wait);
//			MSAzureVideo2Audio.verifyVideo2AudioConvertFunctionalityInMSAzure();
