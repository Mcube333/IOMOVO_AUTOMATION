...
public class CreateIoPortalFunctionalityTests extends BaseClass 
{
	/**
	...
	public void verifyCreatePortalFunctionality() {
		try {
			...
			CreateIoPortalFunctionality IoPortal1 = new CreateIoPortalFunctionality(driver, wait);
			IoPortal1.verifyCreatePortalFunctionality();
