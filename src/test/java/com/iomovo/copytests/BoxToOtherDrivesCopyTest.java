...
public class BoxToOtherDrivesCopyTest extends BaseClass 
{
	...
	public void verifyCopyFilesFunctionalityFromBOXToOtherDrives() {
		try {
			...
			BoxDriveCopyFunctionality IoCloudDrive = new BoxDriveCopyFunctionality(driver, wait);
			IoCloudDrive.verifyCopyFilesFunctionalityFromBOXToIoCloudDrive();
			
			BoxDriveCopyFunctionality AWSDrive = new BoxDriveCopyFunctionality(driver, wait);
			AWSDrive.verifyCopyFilesFunctionalityFromBOXToAWSDrive();
			
			BoxDriveCopyFunctionality BOXDrive = new BoxDriveCopyFunctionality(driver, wait);
			BOXDrive.verifyCopyFilesFunctionalityFromBOXToBOXDrive();
			
			BoxDriveCopyFunctionality DropBoxDrive = new BoxDriveCopyFunctionality(driver, wait);
			DropBoxDrive.verifyCopyFilesFunctionalityFromBOXToDropBoxDrive();
			
			BoxDriveCopyFunctionality FTPDrive = new BoxDriveCopyFunctionality(driver, wait);
			FTPDrive.verifyCopyFilesFunctionalityFromBOXToFTPDrive();
			
			BoxDriveCopyFunctionality GoogleCloudDrive = new BoxDriveCopyFunctionality(driver, wait);
			GoogleCloudDrive.verifyCopyFilesFunctionalityFromBOXToGoogleCloudDrive();
			
			BoxDriveCopyFunctionality GoogleDrive = new BoxDriveCopyFunctionality(driver, wait);
			GoogleDrive.verifyCopyFilesFunctionalityFromBOXToGoogleDrive();
			
			BoxDriveCopyFunctionality AzureDrive = new BoxDriveCopyFunctionality(driver, wait);
			AzureDrive.verifyCopyFilesFunctionalityFromBOXToAzureDrive();
			
			BoxDriveCopyFunctionality OneDrive = new BoxDriveCopyFunctionality(driver, wait);
			OneDrive.verifyCopyFilesFunctionalityFromBOXToOneDrive();
			
			BoxDriveCopyFunctionality SFTPDrive = new BoxDriveCopyFunctionality(driver, wait);
			SFTPDrive.verifyCopyFilesFunctionalityFromBOXToSFTPDrive();
			
			BoxDriveCopyFunctionality SharePointDrive = new BoxDriveCopyFunctionality(driver, wait);
