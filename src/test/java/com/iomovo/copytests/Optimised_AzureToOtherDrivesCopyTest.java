...
public class Optimised_AzureToOtherDrivesCopyTest extends BaseClass 
{
	...
	public void verifyCopyFilesFunctionalityFromAzureToOtherDrives() {
		try {
			...
			Optimised_AzureDriveCopyFunctionality IoCloudDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			IoCloudDrive.verifyCopyFilesFunctionalityFromAzureToIoCloudDrive();
			
			Optimised_AzureDriveCopyFunctionality AWSDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			AWSDrive.verifyCopyFilesFunctionalityFromAzureToAWSDrive();
			
			Optimised_AzureDriveCopyFunctionality BoxDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			BoxDrive.verifyCopyFilesFunctionalityFromAzureToBoxDrive();

			Optimised_AzureDriveCopyFunctionality DropBoxDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			DropBoxDrive.verifyCopyFilesFunctionalityFromAzureToDropBoxDrive();

			Optimised_AzureDriveCopyFunctionality FTPDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			FTPDrive.verifyCopyFilesFunctionalityFromAzureToFTPDrive();

			Optimised_AzureDriveCopyFunctionality GoogleCloudDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			GoogleCloudDrive.verifyCopyFilesFunctionalityFromAzureToGoogleCloudDrive();

			Optimised_AzureDriveCopyFunctionality GoogleDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			GoogleDrive.verifyCopyFilesFunctionalityFromAzureToGoogleDrive();

			Optimised_AzureDriveCopyFunctionality AzureDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			AzureDrive.verifyCopyFilesFunctionalityFromAzureToAzureDrive();

			Optimised_AzureDriveCopyFunctionality OneDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			OneDrive.verifyCopyFilesFunctionalityFromAzureToOneDrive();

			Optimised_AzureDriveCopyFunctionality OOSDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			OOSDrive.verifyCopyFilesFunctionalityFromAzureToOOSDrive();
			
			Optimised_AzureDriveCopyFunctionality SFTPDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
			SFTPDrive.verifyCopyFilesFunctionalityFromAzureToSFTPDrive();
			
			Optimised_AzureDriveCopyFunctionality SharePointDrive = new Optimised_AzureDriveCopyFunctionality(driver, wait);
